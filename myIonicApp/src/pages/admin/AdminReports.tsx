...
.list-col-header {
  display: grid;
  grid-template-columns: 1.4fr 1fr 110px 1.4fr 100px 120px;
  padding: 10px 24px; background: var(--bg); border-bottom: 1px solid var(--rule);
}
...
/* date/time cell */
.cell-date { font-size: .8125rem; color: var(--ink-2); font-weight: 500; }
.cell-time { display: flex; align-items: center; gap: 5px; font-size: .8125rem; color: var(--ink-2); font-weight: 500; }
.cell-time svg { width: 12px; height: 12px; stroke: var(--ink-3); flex-shrink: 0; }

/* description cell */
.cell-desc { font-size: .8125rem; color: var(--ink-2); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; padding-right: 8px; }
...
.attach-link {
  ...
  background: #dbeafe; border-radius: var(--r-md);
  transition: all .15s var(--ease);
}
.attach-link:hover { background: var(--blue); color: #fff; }
.attach-link svg { width: 13px; height: 13px; stroke: currentColor; }
...
.status-pending  { background: var(--warn-bg);   color: var(--warn);   border: 1px solid var(--warn-ring);   }
.status-pending  .status-dot { background: var(--warn); }
.status-approved { background: var(--ok-bg);     color: var(--ok);     border: 1px solid var(--ok-ring);     }
.status-approved .status-dot { background: var(--ok); }
.status-declined { background: var(--danger-bg); color: var(--danger); border: 1px solid var(--danger-ring); }
.status-declined .status-dot { background: var(--danger); }

/* action buttons */
.row-actions { display: flex; align-items: center; gap: 6px; }
.action-btn {
  height: 30px; border: none; border-radius: var(--r-md);
  display: inline-flex; align-items: center; gap: 5px;
...
.btn-approve:hover { background: var(--ok); color: #fff; transform: scale(1.04); }
.btn-decline { background: var(--danger-bg); color: var(--danger); }
.btn-decline:hover { background: var(--danger); color: #fff; transform: scale(1.04); }
.btn-view-sm { background: #dbeafe; color: var(--blue); }
.btn-view-sm:hover { background: var(--blue); color: #fff; transform: scale(1.04); }

/* ─── RESPONSIVE ─────────────────────────── */
@media (max-width: 1200px) {
  .list-col-header, .report-row { grid-template-columns: 1.4fr 1fr 100px 1fr 90px; }
  .list-col-header .col-label:nth-child(4),
  .report-row .cell-desc { display: none; }
}
...
/* ─── LOGOUT MODAL ───────────────────────── */
.modal-overlay {
  position: fixed; inset: 0; background: rgba(26,16,37,.45);
      ...
      <div className="shell">
        ...
        <aside className="sidebar">
          ...
          <nav className="sidebar-nav">
            ...
            <ul>
              <li>
                <a href="AdminReports.html" className="active">
            ...
            <div className="stats-grid">
              <div className="stat-card">
                <div className="stat-icon-wrap ic-pending">
                  <svg viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><circle cx="12" cy="14" r="1"/><line x1="12" y1="11" x2="12" y2="11.01"/></svg>
                </div>
                <div>
              ...
              <div className="stat-card">
                <div className="stat-icon-wrap ic-declined">
                ...
                <div>
                  <div className="stat-label">Declined Reports</div>
            ...
            <div className="reports-section">
              <div className="section-head">
                <div className="section-head-title">
                  ...
                  <span className="count-badge">1 report</span>
                </div>
                ...
                <div className="report-row">
                  <div className="trainee-identity">
                    ...
                    <div className="trainee-info">
                      ...
                      <div className="trainee-course">BS Information Technology – 3A</div>
                    </div>
                  </div>
                  <div>
                    <div className="cell-date" style={{display: 'flex', alignItems: 'center', gap: '5px', marginBottom: '4px'}}>
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{stroke: 'var(--ink-3)'}}><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                      Feb 15, 2026
                    </div>
                  ...
                  <div className="cell-desc">Completed internship tasks for the day.</div>
                  <div>
                  ...
                  <div className="row-actions">
                    ...
                    <button className="action-btn btn-decline">
