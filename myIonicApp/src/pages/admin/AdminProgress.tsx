...
/* column header */
.list-col-header {
  display: grid; grid-template-columns: 1fr 80px 1.8fr 100px;
...
.pct-val {
  ...
  color: var(--brand); padding-right: 12px;
}
...
.bar-track {
  ...
  background: var(--rule); border-radius: var(--r-full);
  overflow: hidden;
}
.bar-fill {
...
.status-on-track { background: var(--ok-bg);     color: var(--ok);     border: 1px solid var(--ok-ring);   }
.status-on-track  .status-dot { background: var(--ok); }
.status-at-risk   { background: var(--warn-bg);  color: var(--warn);   border: 1px solid var(--warn-ring); }
.status-at-risk   .status-dot { background: var(--warn); }
.status-behind    { background: var(--danger-bg); color: var(--danger); border: 1px solid var(--danger-ring); }
.status-behind    .status-dot { background: var(--danger); }
...
.modal-box {
  ...
  box-shadow: var(--sh-lg); text-align: center; animation: slideUp .25s var(--ease);
}
        ...
        <aside className="sidebar">
          ...
          <nav className="sidebar-nav">
            ...
            <ul>
              ...
              <li>
                <a href="AdminProgress.html" className="active">
            ...
            <div className="progress-section">
              ...
              <div className="progress-list">
                ...
                <div className="progress-row">
                  ...
                  <div className="bar-wrap">
                    <div className="bar-track">
                      <div className="bar-fill mid" style={{width: '50%'}}></div>
                    </div>
                  </div>
                  <div>
                    <span className="status-badge status-on-track">
                ...
                <div className="progress-row">
                  ...
                  <div className="pct-val" style={{color: 'var(--warn)'}}>40%</div>
                  <div className="bar-wrap">
                    <div className="bar-track">
                  ...
                  <div>
                    <span className="status-badge status-at-risk">
                      <span className="status-dot"></span>At Risk
                    </span>
                  </div>
                </div>
