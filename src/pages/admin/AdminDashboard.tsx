        ...
        <div className="main">
          ...
          <div className="topbar">
            ...
            <div className="topbar-right">
              <span className="topbar-date">Feb 27, 2026</span>
          ...
          {/* Scrollable content area — only scrolls when content overflows */}
            ...
            <div className="page-content">
                ...
                <div className="stat-card stat-card-trainees">
                  ...
                  <div>
                    ...
                    <div className="stat-trend trend-up">
                      <svg viewBox="0 0 24 24" fill="none" strokeWidth="2.5" strokeLinecap="round"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg>
                      +2 this month
                    </div>
                  </div>
                </div>
                <div className="stat-card stat-card-reports">
                  ...
                  <div>
                    ...
                    <div className="stat-trend trend-warn">
                      <svg viewBox="0 0 24 24" fill="none" strokeWidth="2.5" strokeLinecap="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                      Needs attention
                    </div>
                  </div>
                </div>
              ...
              <div className="activity-section">
                <div className="section-head">
                  <div className="section-head-title">Recent Activity<span className="count-badge">3 entries</span></div>
                  ...
                  <div className="activity-row">
                    ...
                    <div className="row-action">
                      <span className="action-pill pill-login">
                        <svg viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><polyline points="10 17 15 12 10 7"/><line x1="15" y1="12" x2="3" y2="12"/></svg>
                        Logged in
                      </span>
                    </div>
