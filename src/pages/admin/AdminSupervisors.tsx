...
const AdminSupervisors: React.FC = () => {
  ...
  const handleExport = () => {
    ...
    const csvContent = [
      headers.join(','),
      ...supervisorData.map(s => [s.id, `"${s.name}"`, `"${s.office}"`].join(','))
    ].join('\n');
  ...
  const goView   = (id: string) => { history.push('/admin-supervisor-detail'); };
              ...
              <div className="supervisor-row">
                <div className="supervisor-identity">
                  ...
                  <div className="supervisor-info">
                    <button className="supervisor-name" onClick={() => goView('SUP-00101')}>William Shakespear</button>
                ...
                <div className="supervisor-actions">
                  <button className="action-btn action-view" title="View" onClick={() => goView('SUP-00101')}>
                    <svg viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                  </button>
                  <button className="action-btn action-edit" title="Edit" onClick={() => goEdit('SUP-00101')}>
                    <svg viewBox="0 0 24 24"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                  </button>
                  <button className="action-btn action-delete" title="Delete" onClick={() => goDelete('SUP-00101')}>
